<template>
    <div id="shop_container">
        <head-top go-back="true" :head-title="shopDetailData.name"></head-top>
...
export default {
    ...
    methods: {
        ...
        getFoodListHeight() {
            ...
            const baseHeight = this.$refs.shopheader.clientHeight;//header高度
            const chooseTypeHeight = this.$refs.chooseType.clientHeight;//商品评价 高度
        ...
        //获取不同类型的评论列表
        async changeTaeIndex(index, name) {
