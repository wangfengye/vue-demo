 <template>
    <div>
        <head-top :head-title="shopDetailData.name" go-back='true'></head-top>
    ...
    methods: {
        ...
        getFoodListHeight() {
            ...
            listArr.forEach((item, index) => {
                console.log("item: " + item.offsetTop + "," + baseHeight + ',' + chooseTypeHeight);
                this.shopListTop[index] = item.offsetTop - baseHeight - chooseTypeHeight;
                console.log("top: " + this.shopListTop[index])
            });
